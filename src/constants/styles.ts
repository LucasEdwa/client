...
export const styles = {
  ...
  donation: {
    ...
    contentContainer: "lg:w-[29rem] rounded-2xl items-center lg:absolute z-20 top-4 left-0 justify-center xs:w-[100%] px-2 py-4 lg:m-4 text-white shadow-lg lg:rounded-2xl",
