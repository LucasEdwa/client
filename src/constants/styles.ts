...
export const styles = {
  nav: {
    ...
    themeButton: "bg-transparent px-2 py-1 rounded-full hover:opacity-90 transition-all cursor-pointer",
    brandLink: "hover:rounded-xl p-1 transition-all",
    menuButton: "text-2xl",
    dropdownMenu: "flex flex-col p-4 absolute gap-2 left-0 w-full z-40 mt-4",
    dropdownItems: "flex flex-col px-5 w-full text-left",
    dropdownItem: "text-xs hover:rounded-xl p-1 hover:scale-105 w-full",
    link: "hover:opacity-80 transition-all hover:scale-105 p-1 rounded-xl",
  ...
  donation: {
    ...
    contentContainer: "lg:w-[29rem] rounded-2xl items-center lg:absolute z-20 top-4 left-0 justify-center xs:w-[100%] px-2 py-2 lg:m-4 text-white shadow-lg lg:rounded-2xl",
    title: "text-3xl font-bol ml-4 p-2",
    formContainer: "flex flex-col p-4",
    description: "text-md p-8",
    radioGroup: "flex items-center gap-2",
    radioLabel: "text-sm",
    image: "w-full lg:h-[40rem] xs:h-[10rem] object-cover p-4 right-0 top-0",
  },
  footer: {
    container: "py-8 px-4",
  ...
  privateDonationForm: {
    ...
    button: "p-2 border-1 text-center cursor-pointer",
    activeButton: "bg-blue-700 border-none",
    donationMessageContainer: "mx-6",
    customDonationInput:
  ...
  companyDonationForm: {
    formContainer: "w-full max-w-md mx-auto p-5 shadow-md",
    buttonContainer: "flex w-full",
    button: "w-full p-2 border-1 text-center cursor-pointer",
    activeButton: "bg-blue-700 border-none",
    donationMessageContainer: "mx-6 my-4",
    customInputHolder: "flex flex-col  gap-2 items-left",
    customDonationInput:
      "w-full p-2 bg-transparent border-b-1 border-white placeholder-white",
  ...
  aboutStyles: {
    container: "text-center",
    goalCard:
      "bg-transparent shadow-[0_0_60px_rgba(20,142,118,0.835)] rounded-md p-5",
  ...
  paymentStyles: {
    ...
    form: {
      ...
      cardContainer: "mb-5",
      button:
        "w-full p-2 bg-blue-500 text-white rounded mt-2 hover:bg-blue-700 transition-colors",
    },
  },
};
